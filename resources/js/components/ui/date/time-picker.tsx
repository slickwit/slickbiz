...
import { Period, TimePickerType, display12HourValue, getArrowByType, getDateByType, setDateByType } from './time-picker-utils';
...
export default function TimePicker({ picker = '12hours', buttonProps, label, value, date, setDate, period, setPeriod, onClear }: TimePickerProps) {
        ...
        <Popover open={open} onOpenChange={handleOpenChange}>
            <PopoverTrigger asChild>
                <FloatingLabelButon
                    ...
                    {...buttonProps}
                    className={cn(
                        'w-full justify-start overflow-x-clip py-1 text-base font-medium select-none',
            ...
            <PopoverContent className={cn('w-[--radix-popper-anchor-width] min-w-64', !!onClear && 'px-0 pt-3 pb-0')}>
                ...
                {!!onClear && (
                    <Button
                        variant="link"
                        onClick={handleClear}
                        className="mt-2 h-auto w-full rounded-t-none pt-0.5 pb-0.5 hover:bg-foreground/5 hover:no-underline"
                    >
                        Clear
                    </Button>
                )}
...
const TimePickerInput = React.forwardRef<HTMLInputElement, TimePickerInputProps>(
    ({ className, type = 'tel', value, id, name, date, setDate, onChange, onKeyDown, picker, period, onLeftFocus, onRightFocus, ...props }, ref) => {
        ...
        return (
            <div className="flex items-center">
                <Button
                    ...
                    className="text-forground focus:ring-forground h-9 border-input ring-offset-background hover:shadow-none focus:ring-2 focus:ring-offset-0"
                    type="button"
                    ref={ref}
