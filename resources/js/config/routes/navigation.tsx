                ...
                items: [
                    // COMPANY INFORMATION
                    {
                        ...
                        children: [
                            {
                                title: 'company',
                                path: paths.dashboard.controlPannel.company,
                            },
                            {
                                title: 'project details',
                                path: paths.dashboard.controlPannel.projectDetails,
                            },
                            {
                                title: 'positions',
                                path: paths.dashboard.controlPannel.positions,
                            },
                            {
                                title: 'departments',
                                path: paths.dashboard.controlPannel.departments,
                            },
                        ],
                    },
                        ...
                        children: [
                            {
                                ...
                                children: [
                                    {
                                        title: 'create',
                                        path: paths.dashboard.training.internal.create,
                                    },
                                    {
                                        title: 'register',
                                        path: paths.dashboard.training.internal.register,
                                    },
                                    {
                                        title: 'in house',
                                        path: paths.dashboard.training.internal.inHouse,
                                    },
                                    {
                                        title: 'internal matrix',
                                        path: paths.dashboard.training.internal.matrixReport,
                                    },
                                ],
                            },
                            {
                                ...
                                children: [
                                    {
                                        title: 'create',
                                        path: paths.dashboard.training.external.create,
                                    },
                                    {
                                        title: 'register',
                                        path: paths.dashboard.training.external.register,
                                    },
                                    {
                                        title: 'third party',
                                        path: paths.dashboard.training.external.thirdParty,
                                    },
                                    {
                                        title: 'internal matrix',
                                        path: paths.dashboard.training.external.matrixReport,
                                    },
                                ],
                            },
                            {
...

                    {
                        ...
                        children: [
                            {
                                title: 'create',
                                path: paths.dashboard.incident.create,
                            },
                            {
                                title: 'list',
                                path: paths.dashboard.incident.list,
                            },
                            {
                                title: 'report',
                                path: paths.dashboard.incident.report,
                            },
                        ],
                    },
